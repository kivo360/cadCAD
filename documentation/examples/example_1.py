...
(
    ...
    sys_model_A_tensor_field,
    sessions,
) = sys_model_A_simulation.execute()
...
sys_model_AB_simulation = Executor(
    exec_context=multi_proc_ctx, configs=system_model_AB_exp.configs
)

(
    sys_model_AB_raw_result,
    sys_model_AB_tensor_field,
    sessions,
) = sys_model_AB_simulation.execute()
print()
